                    ...
                    <form method="POST" action="">
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="number" class="form-control" id="ml" name="ml" min="0" max="100">
                            </div>
                            <div class="col-md-6">
                                <label for="sed" class="form-label">Software Engineering & Design</label>
                                <input type="number" class="form-control" id="sed" name="sed" min="0" max="100">
                            </div>
                            <div class="col-md-6">
                                <label for="dt2" class="form-label">Digital Techniques II</label>
                                <input type="number" class="form-control" id="dt2" name="dt2" min="0" max="100">
                            </div>
                            <div class="col-md-6">
                                <label for="wt" class="form-label">Web Technology</label>
                                <input type="number" class="form-control" id="wt" name="wt" min="0" max="100">
                            </div>
                            <div class="col-md-6">
                                <label for="elective1" class="form-label">Elective I</label>
                                <input type="number" class="form-control" id="elective1" name="elective1" min="0" max="100">
                            </div>
                            <div class="col-md-6">
                                <label for="elective2" class="form-label">Elective II</label>
                                <input type="number" class="form-control" id="elective2" name="elective2" min="0" max="100">
                            </div>
                            <div class="col-12 mt-4">
                                ...
                                <button type="submit" class="btn btn-submit text-white">
                                    <i class="bx bx-plus-circle"></i> Add Student
                                </button>
                            </div>
                        </div>
                    </form>
